...
Date: 10/10/2019
Title: models/lstm/LSTM_2.py
Code Version: 
Availability: 
''' 
'''
This file is extracted from Google Colab notebook LSTM_2.ipynb (neenyabigki, neenyabigki3, neenyabigki5). 
It trains LSTM2 model as described in the final report
'''
import numpy as np
import os
import csv

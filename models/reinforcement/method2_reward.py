...
Date: 10/10/2019
Title: models/reinforcement/method2_reward.py (original3_foo.py)
Code Version: 
Availability: 
''' 
'''
This file defines the environment (gym environment) used in training the DQN (dqn.py/dqn.ipynb).
'''
# reward only given when correct beam pair selected 
# test pair is called test_method2.py
# Reference: https://github.com/openai/gym-soccer/blob/master/gym_soccer/envs/soccer_env.py

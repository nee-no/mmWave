...
class FooEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = spaces.Discrete(256) # 256 actions
    ...
    def reset(self):
        ...
        self._states_available = np.load( '/home/englab5510/PycharmProjects/mmWave1/reinforcement_data/trial2/input_train/sample{}.npy'.format(ep_ind))
        self._power_available = np.load('/home/englab5510/PycharmProjects/mmWave1/reinforcement_data/trial2/output_train/t1_{}.npy'.format(ep_ind))
        self._actions_available = np.load( '/home/englab5510/PycharmProjects/mmWave1/reinforcement_data/trial2/output_train/category{}.npy'.format(ep_ind))
        ...
        #ideal_action = np.where(ideal_action==1) # if not using trial2 data
        #ideal_action = ideal_action[0][0]
        print(ep_ind, ideal_action)

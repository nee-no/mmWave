...
Date: 10/10/2019
Title: models/stacked_ensemble/CNN_model1.py
Code Version: 
Availability: 
''' 
'''
This file is extracted from Google Colab notebook cnn_model1.ipynb (sllee41, neenyabigki2). 
It trains one of the stacked ensemble model (first model) as described in the final report
'''
import numpy as np 
import math

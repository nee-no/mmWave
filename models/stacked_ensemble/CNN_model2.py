...
Date: 10/10/2019
Title: models/stacked_ensemble/CNN_model2.py
Code Version: 
Availability: 
''' 
'''
This file is extracted from Google Colab notebook cnn_model2.ipynb (sllee41, neenyabigki7). 
It trains one of the stacked ensemble model (second model) as described in the final report
'''
import numpy as np 
import math
...
print("Saved model_2.h5\n")

model.save_weights("/content/drive/My Drive/Colab Notebooks/trial3_data/cnn_data_trial3data/model2_2_shortweights.h5")
model_json = model.to_json()
with open("/content/drive/My Drive/Colab Notebooks/trial3_data/cnn_data_trial3data/model2_2_shortarchitecture.json", "w") as json_file:
...
np.savez("/content/drive/My Drive/Colab Notebooks/trial3_data/cnn_data_trial3data/val_acc_2_short.npz",loss=loss, acc=acc, val_loss=val_loss, val_acc=val_acc)

...
Date: 10/10/2019
Title: models/baseline/baseline1.py 
Code Version: 
Availability: 
''' 
'''
CNN model with division of dataset not by scenes but randomly. Baseline1 in final report.
'''
...
np.savez('baseline_models/baseline_deep_ann_val_acc.npz',validation_acc=val_acc, testing_acc=acc, validation_loss=val_loss, testing_loss=loss)
